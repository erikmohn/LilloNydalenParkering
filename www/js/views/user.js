...
function resetErrorColors() {
	$("#user-nameInput").css({ 'color': 'black'});
	$("#user-phoneInput").css({ 'color': 'black'});
	$("#user-parkingLotInput").css({ 'color': 'black'});
	$("#user-regnrInput").css({ 'color': 'black'});
	$("#user-emailInput").css({ 'color': 'black'});
};
